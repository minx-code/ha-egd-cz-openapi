...
### Installation
1. Add this repository to your HACS as a custom repository.
2. Search for "EG.D OpenAPI" and install it.
3. Restart Home Assistant.
4. Go to Settings -> Devices & Services -> Add Integration and search for "EG.D OpenAPI".
...
- Automatická synchronizace historických dat (s možností volby kalendářního počátku nebo neomezené historie).
...
### Instalace
1. Přidejte tento repozitář do HACS jako vlastní repozitář (Custom repository).
2. Vyhledejte "EG.D OpenAPI" a klikněte na Instalovat.
3. Restartujte Home Assistant.
4. Jděte do Nastavení -> Zařízení a služby -> Přidat integraci a vyhledejte "EG.D OpenAPI".
